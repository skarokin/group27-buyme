...
// If there's no new search query, use the last stored search query
if (newSearchQuery == null || newSearchQuery.isEmpty()) {
    newSearchQuery = storedSearchQuery; // Use the last search query if no new query is provided
} else {
    session.setAttribute("lastSearchQuery", newSearchQuery); // Update session with new search query
}
